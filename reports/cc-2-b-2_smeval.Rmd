---
title: "Climate Crisis Iteration 2-b-2 (Heating) Structural Model Evaluation"
output: 
...
sumplspre <- tar_read("cc_model_2_b_2_plspre")
# Make summaries
summo <- summary(model)
...
The effect sizes of Threat Beliefs and Descriptive Norm on Behavioral Intention, as well as the effect size of Knowledge on Response Beliefs, are below 0.02.
...
The path coefficients for the paths from Threat Belief and Descriptive Norm to Behavioral Intention are not significant based on both the t-statistic and the bootstrapping confidence interval.
...
The path from Knowledge to Response Beliefs as well as the paths from Threat Beliefs and Descriptive Norm to Behavioral Intention are insignificant and the effect sizes are negligible.
