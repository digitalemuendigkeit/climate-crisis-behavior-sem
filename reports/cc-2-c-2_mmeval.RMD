...
The weight of CCDN1 is insignificant, however, the loading is sufficiently large.
...
The weights for Perceived Self-Efficacy and Distrusting Beliefs Integrity are non-significant, but the loadings are sufficiently large.
All other weights are significant and relevant.

## Results of the mode B higher-order constructs evaluation

The mode B higher-order constructs can be retained as-is.
