...
```
CCPN2 shows the highest intercorrelation with the other indicators and should therefore be deleted. All other reflective indicators can be retained as-is.
...
The other formative higher-order constructs can be retained as-is.
