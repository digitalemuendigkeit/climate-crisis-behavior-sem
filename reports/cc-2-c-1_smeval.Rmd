---
title: "Climate Crisis Iteration 2-c-1 (Driving) Structural Model Evaluation"
output: 
...
sumplspre <- tar_read("cc_model_2_c_1_plspre")
# Make summaries
summo <- summary(model)
...
The effect sizes of Threat Beliefs, Personal Moral Norm, and Subjective Norm on Behavioral Intention, as well as the effect size of Knowledge on Response Beliefs, are below 0.02.
...
Only CCBI3 is predicted better by the model than the LM in terms of both RMSE and MAD.
...
The path coefficients from Threat Beliefs, Personal Moral Norm, and Subjective Norm to Behavioral Intention, as well as the path coefficient for the path from Knowledge to Response Beliefs, are all not significant based on both the t-statistic and the bootstrapping confidence interval.
...
The paths from Threat Beliefs, Personal Moral Norm, and Subjective Norm to Behavioral Intention, and the path from Knowledge to Response Beliefs, are insignificant and the effect sizes are negligible.
