---
title: "Climate Crisis Iteration 2-b-2 (Heating) Measurement Model Evaluation"
output: 
...
bootfsmodel <- tar_read("cc_model_2_b_2_fs_boot")
ralist <- tar_read("cc_model_2_b_2_ra")
# Create summaries
summo <- summary(model)
...
The weights of CCDN1 is insignificant, however, the loading is sufficiently large.
