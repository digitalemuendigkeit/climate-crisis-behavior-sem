---
title: "Climate Crisis Iteration 2-a-1 (Diet) Measurement Model Evaluation"
site: 
...
model <- tar_read("cc_model_2_a_1")
bootmodel <- tar_read("cc_model_2_a_1_boot")
bootfsmodel <- tar_read("cc_model_2_a_1_fs_boot")
ralist <- tar_read("cc_model_2_a_1_ra")
# Create summaries
summo <- summary(model)
...
Perceived Response Costs has to be removed, otherwise the mode B higher-order constructs can be retained as-is.
