---
title: "Climate Crisis Iteration 2-a-3 (Diet) Nonlinearity Evaluation"
output:
...
bootprmodel <- tar_read("cc_model_2_a_3_proxy_boot")
# Make summaries
summo <- summary(model)
...
mobi1altex <- estimate_pls(
  ...
  structural_model = relationships(
    paths(from = c("Distrusting Beliefs", "Knowledge"), to = "Behavioral Intention")
  )
)
