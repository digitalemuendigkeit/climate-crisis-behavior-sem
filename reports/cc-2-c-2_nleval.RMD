---
title: "Climate Crisis Iteration 2-c-2 (Driving) Nonlinearity Evaluation"
output:
...
bootprmodel <- tar_read("cc_model_2_c_2_proxy_boot")
# Make summaries
summo <- summary(model)
...
For the alternate model, Distrusting Beliefs is specified as a quadratic influence.
Although the correct method would be two-stage, only the orthogonal and product-indicator methods worked.
Using either of those methods, the effect size does not clear the 0.02 threshold, and the t-statistic does not indicate significance.
