...
R² is below 0.25 for Response Beliefs and Behavioral Intention, but not below 0.1.
The R² values for Threat Beliefs is above 0.25, indicating weak in-sample predictive power at a minimum.
...
The effect sizes of Threat Beliefs, Descriptive Norm, and Response Beliefs on Behavioral Intention, as well as the effect size of Knowledge on Response Beliefs, are below 0.02.
...
The path coefficients for the paths from Threat Belief, Descriptive Norm, and Response Beliefs to Behavioral Intention are not significant based on both the t-statistic and the bootstrapping confidence interval.
So is the path coefficient for the path from Knowledge to Response Beliefs.
...
The path from Knowledge to Response Beliefs as well as the paths from Threat Beliefs, Response Beliefs, and Descriptive Norm to Behavioral Intention are insignificant and the effect sizes are negligible.
Therefore, those paths can be removed from the model.
Alternatively, as the measurement model results for the Perceived Self-Efficacy lower-order construct were on the edge, an alternate model with Perceived Response Efficacy instead of Response Beliefs could be estimated.
