...
list(
  ...
  tar_target(
    cc_model_1_ra,
    redundancy_cc(cc_model_1, survey_data_cc_sem)
  ),
  tar_target(
    survey_data_addan,
  ...
  tar_target(
    cc_model_2_a_1_ra,
    redundancy_cc(cc_model_2_a_1, survey_data_cc_sem)
  ),
  tar_target(
    cc_model_2_a_2,
    estimate_cc_2_a_2(survey_data_cc_sem)
  ...
  tar_target(
    cc_model_2_a_2_ra,
    redundancy_cc(cc_model_2_a_2, survey_data_cc_sem)
  ),
  tar_target(
    cc_model_2_a_2_proxy,
    estimate_cc_2_a_2_proxy(survey_data_cc_sem)
  ...
  tar_target(
    cc_model_2_a_3_ra,
    redundancy_cc(cc_model_2_a_3,survey_data_cc_sem)
  ),
  tar_target(
    cc_model_2_a_3_proxy,
    estimate_cc_2_a_3_proxy(survey_data_cc_sem)
  ...
  tar_target(
    cc_model_2_a_4_ra,
    redundancy_cc(cc_model_2_a_4,survey_data_cc_sem)
  ),
  tar_target(
    cc_model_2_a_4_proxy,
    estimate_cc_2_a_4_proxy(survey_data_cc_sem)
  ...
  tar_target(
    cc_model_2_b_1_ra,
    redundancy_cc(cc_model_2_b_1,survey_data_cc_sem)
  ),
  tar_target(
    cc_model_2_b_2,
    estimate_cc_2_b_2(survey_data_cc_sem)
  ...
  tar_target(
    cc_model_2_b_2_ra,
    redundancy_cc(cc_model_2_b_2,survey_data_cc_sem)
  ),
  tar_target(
    cc_model_2_b_2_proxy,
    estimate_cc_2_b_2_proxy(survey_data_cc_sem)
  ...
  tar_target(
    cc_model_2_b_3_ra,
    redundancy_cc(cc_model_2_b_3,survey_data_cc_sem)
  ),
  tar_target(
    cc_model_2_b_3_proxy,
    estimate_cc_2_b_3_proxy(survey_data_cc_sem)
  ...
  tar_target(
    cc_model_2_c_1_ra,
    redundancy_cc(cc_model_2_c_1,survey_data_cc_sem)
  ),
  tar_target(
    cc_model_2_c_1_proxy,
    estimate_cc_2_c_1_proxy(survey_data_cc_sem)
  ...
  tar_target(
    cc_model_2_c_2_ra,
    redundancy_cc(cc_model_2_c_2,survey_data_cc_sem)
  ),
  tar_target(
    cc_model_2_c_2_proxy,
    estimate_cc_2_c_2_proxy(survey_data_cc_sem)
  ...
  tar_target(
    cc_model_2_d_1_ra,
    redundancy_cc(cc_model_2_d_1,survey_data_cc_sem)
  ),
  tar_target(
    cc_model_2_d_1_proxy,
    estimate_cc_2_d_1_proxy(survey_data_cc_sem)
  ...
  tar_target(
    cc_model_2_d_2_ra,
    redundancy_cc(cc_model_2_d_2,survey_data_cc_sem)
  ),
  tar_target(
    cc_model_2_d_2_proxy,
    estimate_cc_2_d_2_proxy(survey_data_cc_sem)
