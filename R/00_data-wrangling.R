...
#
#   decstatclimate <- descstatshort %>%
#     filter(!grepl('COVID-19', Variable)) %>%
#     filter(!((grepl('Perceived', Variable) |
#                 grepl('Intention', Variable)) &
#                (grepl('Diet', Variable) |
#                   grepl('Heating', Variable) |
#                   grepl('Driving', Variable) |
#                   grepl('General', Variable)))) %>%
#     mutate(Variable = gsub('Climate ', '', Variable))
#
#
